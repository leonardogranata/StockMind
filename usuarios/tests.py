...
class UsuarioTestCase(TestCase):
    def test_cadastro_usuario_senhas_iguais(self):
        ...
        print("✔️ Teste 1 - Cadastro de usuário com senhas iguais concluído com sucesso.")
    ...
    def test_cadastro_usuario_senhas_diferentes(self):
        ...
        print("✔️ Teste 2 - Validação de senhas diferentes concluída com sucesso.")

    def test_senha_curta(self):
        senha = "123"
        self.assertTrue(len(senha) < 8, "A senha informada deveria ser considerada curta.")
        print("✔️ Teste 3 - Verificação de comprimento mínimo da senha concluída com sucesso.")
...
class TestUsuario(TestCase):
    def test_criar_usuario_valido(self):
        ...
        print("✔️ Teste 4 - Criação de usuário válido concluída com sucesso.")

    def test_nao_cria_senhas_diferentes(self):
        senha = "abc123"
        confirmar = "abc321"
        self.assertNotEqual(senha, confirmar, "As senhas informadas não deveriam coincidir.")
        print("✔️ Teste 5 - Validação de senhas diferentes concluída com sucesso.")
